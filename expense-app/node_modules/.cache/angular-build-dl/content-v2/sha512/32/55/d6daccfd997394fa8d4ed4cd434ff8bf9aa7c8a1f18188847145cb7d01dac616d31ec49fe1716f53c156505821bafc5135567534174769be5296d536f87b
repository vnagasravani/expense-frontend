...
let GroupComponent = class GroupComponent {
    constructor(route, appService, SocketService, router, toaster, spinner) {
        ...
        this.delExpenseResponse = () => {
            this.SocketService.expenseDelResponse().subscribe((data) => {
                if (data.status == 200) {
        ...
        this.editAmountResponse = () => {
            this.SocketService.editAmountResponse().subscribe((data) => {
        ...
        this.editPeopleResponse = () => {
            this.SocketService.editPeopleResponse().subscribe((data) => {
        ...
        this.deletePeopleResponse = () => {
            this.SocketService.removePeopleResponse().subscribe((data) => {
        ...
        this.editWhoPaidResponse = () => {
            this.SocketService.editWhoPaidResponse().subscribe((data) => {
